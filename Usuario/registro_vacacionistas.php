...
$conexion = mysqli_connect("$servidor", "$usuario", "$clave", "$bd") or die("Problemas con la conexión");
?>
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Registro de vacacionistas</title>
    <link rel="stylesheet" href="css/registro_vacacionistas.css">
...
if(isset($_POST['enviar'])){
    ...
    $talla = ($_POST['camisa'] == 'NO') ? 'NINGUNA' : $_POST['tallas'];
...
?>
  <script type="text/javascript" src="js/registro_vacacionistas.js"></script>
</html>
